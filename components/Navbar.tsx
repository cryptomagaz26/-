  ...
  return (
    <nav className="h-20 border-b border-slate-800 bg-slate-950/80 backdrop-blur-xl sticky top-0 z-50 px-8 flex items-center justify-between">
      ...
      <div className="hidden lg:flex items-center gap-8">
        <button onClick={onHomeClick} className="text-sm font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-widest">강의 탐색</button>
        <button className="text-sm font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-widest">자산 분석</button>
        <button className="text-sm font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-widest">내 강의실</button>
        <button className="text-sm font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-widest">인사이트</button>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative hidden sm:block">
          ...
          <input 
            ...
            className="bg-slate-900 border border-slate-800 rounded-full pl-10 pr-5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 w-64 transition-all"
          />
        </div>
